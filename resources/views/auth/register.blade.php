    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header title-text acc-text">{{ __('Registrati') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3 row">
                            <label for="password-confirm" class="col-md-4 form-label text-md-right">{{ __('Conferma Password') }}</label>
